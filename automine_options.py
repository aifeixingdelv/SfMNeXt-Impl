...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default="/media/root123/ac522/AutoMine/")#os.path.join(file_dir, ".."))
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", 
                                          "cityscapes_preprocessed", "mc_dataset", "mc_mini_dataset",
                                          "nyu_raw", "automine_depth"])
